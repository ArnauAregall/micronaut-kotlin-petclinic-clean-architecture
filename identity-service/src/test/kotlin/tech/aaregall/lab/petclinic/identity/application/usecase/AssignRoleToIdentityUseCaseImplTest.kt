...
import tech.aaregall.lab.petclinic.identity.application.ports.usecase.AssignRoleToIdentityUseCaseImpl
...
internal class AssignRoleToIdentityUseCaseImplTest {
    ...
    @InjectMockKs
    lateinit var useCase: AssignRoleToIdentityUseCaseImpl
