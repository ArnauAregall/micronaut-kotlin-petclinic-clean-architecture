...
import tech.aaregall.lab.petclinic.pet.application.ports.usecase.SearchPetsUseCase
...
internal class SearchPetsUseCaseTest {
    ...
    @InjectMockKs
    lateinit var useCase: SearchPetsUseCase
